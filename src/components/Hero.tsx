        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '1s' }}>
            ...
            <Button
              ...
              className="bg-transparent border-white text-white hover:bg-primary hover:text-primary-foreground hover:border-primary px-8 py-6 text-sm tracking-wide uppercase backdrop-blur-sm transition-all duration-300 hover:scale-105"
            >
